...
class PretrainDataset(Dataset):
    ...
    def __init__(
        self,
        image_annotation_path='data/video-llava/train_json/llava_image_.json',
        video_annotation_path='data/video-llava/train_json/valid_valley_.json',
        ...
        audiocaps_data_root='data/AudioCaps',
        audio_caption_task=False,
        grounded_vqa_data_root='data/GroundedVQA',
        segmentation_task=False,
        image_scale_nums = 2,
        token_nums_per_scale = 3,
        lvis_data_root='data/LVIS',
